...
def p_rec(rec, benefits, h_seq, fhseq, ffpos):
    ...
    record["pecert1"] = int(rec[120:122])
    record["pecert2"] = int(rec[122:124])
    record["pecert3"] = int(rec[124:126])
    ...
    record["pxcert1"] = int(rec[846:848])
    record["pxcert2"] = int(rec[848:850])
    record["pxcert3"] = int(rec[850:852])
...
if __name__ == "__main__":
    create_cps(
        Path(CUR_PATH, "data", "asec2018_pubuse.dat"), 2018, False
    )
