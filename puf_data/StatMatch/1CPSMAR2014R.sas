...
libname library "C:\Users\anderson.frailey\Documents";

*  The following line should contain
   the complete path and name of the raw data file.
   On a PC, use backslashes in paths as in C:\	 ;

FILENAME datafile "C:\Users\anderson.frailey\Documents\Matching Project\asec2014_pubuse_tax_fix_5x8.dat";
...
;
*/
proc contents data=library.cpsmar2014;
run;
/*
