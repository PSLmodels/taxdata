...
def p_rec(rec, benefits, h_seq, fhseq, ffpos):
    ...
    record["m5g_cbst"] = int(rec[1073:1074])
    record["m5g_dscp"] = int(rec[1074:1075])
    record["m5gsame"] = int(rec[1075:1076])
    record["m5g_reg"] = int(rec[1076:1077])
    record["m5g_st"] = int(rec[1077:1079])
    record["m5g_div"] = int(rec[1079:1081])
    record["m5g_mtr1"] = int(rec[1081:1083])
    record["m5g_mtr3"] = int(rec[1083:1084])
    record["m5g_mtr4"] = int(rec[1084:1085])
    record["i_m5g1"] = int(rec[1085:1086])
