...
libname library "C:\Users\anderson.frailey\Documents\State Database - 2015\CPS Tax Units\2013\Extracts\";

*  The following line should contain
   the complete path and name of the raw data file.
   On a PC, use backslashes in paths as in C:\	 ;

FILENAME datafile "C:\Users\anderson.frailey\Documents\State Database - 2015\CPS Files\March 2013\asec2013_pubuse.dat";

*  The following line should contain the name of the SAS dataset ;

%let dataset = cpsmar2013 ;
...
in a sas data set called fcpmar2013 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar2013;
PROC freq;
        tables PULAYCK1 ;
...
PROC FORMAT cntlout=library.fcpmar2013;
...
proc print data=library.cpsmar2013 (obs=6);
...
FORMAT
	...
	tchsp_val  tchsp_val.
;
proc contents data=library.cpsmar2013;
run;
/*
