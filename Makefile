...
FILES_TO_MAKE = puf_stage1/growfactors.csv
...
cps_stage4/cps_benefits.csv.gz: cps_stage4/rename_columns.py \
                                ...
                                cps_data/cps_raw.csv.gz \
                                cps_stage2/cps_weights.csv.gz
	cd cps_stage4 && python rename_columns.py
	cd cps_stage4 && python extrapolation.py
	@rm cps_data/cps_raw_rename.csv.gz
